...
for %%s in (700) do (    
    for %%t in (EffectOrientedNonDecoupledSpray) do (
        (
            ...
            @REM python .\main.py --config %config% --seed 0 --strategy_name %%t --team_size 2 --bound1 %%s
            @REM python .\main.py --config %config% --seed 0 --strategy_name %%t --team_size 3 --bound1 %%s
            @REM python .\main.py --config %config% --seed 0 --strategy_name %%t --team_size 4 --bound1 %%s
